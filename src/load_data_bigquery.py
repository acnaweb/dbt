...
os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = "/shared/credentials/study-bigquery.json"
...
def load_bigquery(table_name, csv_file_path):
...
for table_name, csv_file_path in csv_files.items():
    load_bigquery(table_name, csv_file_path)
